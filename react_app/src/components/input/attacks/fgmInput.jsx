...
const FGMInput = ({
  epochs, handleEpochsChange,
  batchSize, handleBatchSizeChange,
  epsValue, handleEpsChange,
  epsStepValue, handleEpsStepChange,
  normValue, handleNormChange,
  datasetSelected
}) => {
  return (
    <div className="text-boxes-section mb-3">
      ...
      <div className="mb-3">
        ...
        >
          <strong>
            Norm - The norm used for measuring the size of the
            perturbation
          </strong>
        </label>
        <select
