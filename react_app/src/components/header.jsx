...
import { MDBContainer, MDBNavbar, MDBNavbarBrand, MDBNavbarItem, MDBNavbarLink, MDBDropdown, MDBDropdownToggle, MDBDropdownMenu, MDBDropdownItem } from 'mdb-react-ui-kit';
    ...
    <>
      <MDBNavbar light bgColor='light'>
        <MDBContainer fluid>
          ...
          <MDBNavbarItem style={{ marginRight: '50px', listStyleType: 'none' }}>
            <MDBDropdown>
          ...
          <MDBNavbarItem style={{ listStyleType: 'none' }}>
            <MDBNavbarLink href='https://www.google.com' target='_blank'>
              About
            </MDBNavbarLink>
          </MDBNavbarItem>
        </MDBContainer>
