...
This testing suite for machine learning is designed to assess and improve the robustness of models against adversarial attacks. It leverages the powerful [Adversarial Robustness Toolkit](https://github.com/Trusted-AI/adversarial-robustness-toolbox) (ART) library to provide a comprehensive set of tools and metrics for analyzing and mitigating model vulnerabilities.
...
- **Attack Generation**: Utilizes advanced techniques to generate adversarial examples and test the model’s ability to withstand such inputs.
...
- **Robustness Testing**: Evaluates model resilience to various types of adversarial attacks, including imperceptible perturbations and strategic manipulations.
...
See the documentation project docs **[here](https://github.com/Endless077/ML_Security_Project/docs)**.
